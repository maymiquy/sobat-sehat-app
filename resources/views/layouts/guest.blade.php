                    ...
                    <div class="pt-4 pb-1 border-t border-gray-200">
                        @if (Route::has('login'))
                            <x-responsive-nav-link href="{{ route('login') }}"
                                class="block px-4 py-2 text-sm text-green-500">{{ __('Login') }}</x-responsive-nav-link>
                        @endif

                        @if (Route::has('register'))
                            <x-responsive-nav-link href="{{ route('register') }}"
                                class="block px-4 py-2 text-sm text-blue-500">{{ __('Register') }}</x-responsive-nav-link>
                        @endif
                    @else
                        @if (Auth::user()->role === 'Admin')
                            <div class="px-4">
